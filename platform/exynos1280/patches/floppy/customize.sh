BUILD_KERNEL()
{
    ...
    EVAL "mkdtboimg cfg_create "kernel_build/dtbo.img" "$SRC_DIR/platform/exynos1280/patches/floppy/configs/${TARGET_CODENAME}.cfg" -d "out/arch/arm64/boot/dts/exynos/samsung/${TARGET_CODENAME}""
